...
|---|---|---|
| 类比 | 学校考试 | 计算机上机考试 |
| 评什么 | **主要评模型本身**（「智商」、知识、卷面答案） | **评模型 × [Harness](../harness/) 的执行能力** |
...
| 技术 | 关系 |
|---|---|
| [Harness](../harness/) | Agent 分数 = 模型 × 外壳；换循环就要重测 |
...
| [Agent Skills](../agent-skills/) | 「是否遵守硬规则」是便宜的程序裁判 |
...
- 对比：[harness](../harness/)、[guardrails](../guardrails/)、[agent-skills](../agent-skills/)
