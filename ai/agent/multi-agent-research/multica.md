...
>
> 仓库：[https://github.com/multica-ai/multica](https://github.com/multica-ai/multica) ｜ 文档：[https://multica.ai/docs](https://multica.ai/docs) ｜ [VISION.md](https://github.com/multica-ai/multica/blob/main/VISION.md)  
...
对照总判断见 [README](./README.md)。落地四段见 [sdlc.md](./sdlc.md)。逛源码按 [multica-architecture.md](./multica-architecture.md)。它落地的是「工作系统」，不是「模型怎么推理」。
