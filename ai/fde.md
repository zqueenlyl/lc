...
| 循环与图工程（验证闭环 + 执行图 + 上下文图 / GraphRAG） | [agent/loop-graph/](./agent/loop-graph/) · [agent/case-studies/langgraph/](./agent/case-studies/langgraph/) |
...
| SOP / 技能包沉淀（自转关） | [agent/agent-skills/](./agent/agent-skills/) · [agent/loop-graph/](./agent/loop-graph/) |
