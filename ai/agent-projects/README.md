# 开源 Agent 项目案例 · agent-projects

> 把三个有代表性的开源 Agent 项目当作**落地案例**读，看业界怎么把 [agent 专题](../agent/) 里的理论变成可跑的生产系统。每个项目一篇分析，横向对照「安全哲学、形态、信任来源」三条主线。
...
3. 最后读 [trpc-agent-go](./trpc-agent-go.md)，看一个框架如何把 [mcp](../mcp/)、[a2a](../a2a/)、[langgraph](../langgraph/)、[eval](../eval/) 打包成 Go 实现。
...
| 你想搞懂 | 去 |
|---|---|
| Agent 循环与安全门禁的理论 | [agent](../agent/)、[guardrails](../guardrails/) |
