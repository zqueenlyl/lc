...
对「要长期跑在开发者终端里的 Agent」来说，供应链是攻击面——这跟 [guardrails 专题](../guardrails/) 里的「插件接口公开前，权限模型必须先存在」是同一层担忧。
...
- 相邻专题：[harness](../harness/)、[guardrails](../guardrails/)、[loop-engineering](../loop-engineering.md)
