...
- **可用**：断网仍能草稿、分类、模板填充。
- **给大模型减负**：SLM 做 [routing](../model-routing/)、护栏初筛、工具选择。
...
4. 量化后必须回归 [Eval](../eval/)，4-bit 可能把安全分类打穿。
...
| 技术 | 关系 |
|---|---|
| [Model Routing](../model-routing/) | SLM 是路由表里的默认廉价档 |
| [PEFT / LoRA](./../peft-lora/) | 让 SLM 变领域专家 |
| [Reasoning](../reasoning/) | 蒸馏源；端侧很少开满 thinking |
| [Speculative Decoding](../speculative-decoding/) | SLM 常当草稿模型 |
| [Guardrails](../guardrails/) | 端侧先挡一层，上云再细审 |
...
- 对比：[model-routing](../model-routing/)、[peft-lora](../peft-lora/)、[speculative-decoding](../speculative-decoding/)
